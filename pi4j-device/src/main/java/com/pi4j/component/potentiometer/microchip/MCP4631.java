 ...
 */
public class MCP4631 extends MicrochipPotentiometerBase implements MicrochipPotentiometer {
	...
	/**
	 * @return Whether device is capable of non volatile wipers (false for MCP4631)
	 */
	@Override
	...
	/**
	 * @return The maximal value at which a wiper can be (128 for MCP4631)
	 */
	@Override
	...
	/**
	 * @return Whether this device is a potentiometer or a rheostat (false for MCP4631)
	 */
	@Override
	...
	/**
	 * @return All channels supported by the underlying device (A, B for MCP4631)
	 */
	@Override
